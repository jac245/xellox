// Shop.jsx — BIG hero product (Yokis, includes 3 plates) + add-on grid (single, 3-pack)
function Shop({ onBuy }) {
  return (
      ...
      <div className="container">
        ...
        <div className="shop-hero">
          <div className="copy">
            ...
            <p className="includes">Includes <b>3 plates</b> · <b>tungsten scribe</b> · <b>tamper rivets</b></p>
            <div className="price-row">
              <span className="btc">₿ 0.0042</span>
              <span className="usd">from $249</span>
            </div>
            <div className="ctas">
              <button className="btn btn-primary btn-lg" onClick={() => onBuy('yokis')}>Add to cart</button>
              <a href="#tech" className="btn btn-outline btn-lg">Learn more <i data-lucide="arrow-right"></i></a>
            </div>
          </div>
          <div className="img-stage">
            <img src="../../assets/yokis-front.png" alt="Yokis Steel Backup"/>
          </div>
        </div>
        ...
        <div className="shop-grid">
          <div className="shop-card">
            <div className="meta">
              ...
              <button className="btn btn-outline" style={{ alignSelf: 'flex-start' }} onClick={() => onBuy('plate-1')}>Add to cart</button>
            </div>
            <div className="img-cell">
              <img src="../../assets/yokis-front.png" alt="Single plate"/>
            </div>
          </div>
          ...
          <div className="shop-card">
            <div className="meta">
              ...
              <button className="btn btn-outline" style={{ alignSelf: 'flex-start' }} onClick={() => onBuy('plate-3')}>Add to cart</button>
            </div>
            <div className="img-cell">
              <img src="../../assets/yokis-plates-trio-cut.png" alt="3-plate backup set"/>
            </div>
          </div>
        </div>
      </div>
